...
DROP DATABASE IF EXISTS crm_whatsapp_instagram_facebook;
CREATE DATABASE crm_whatsapp_instagram_facebook DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE crm_whatsapp_instagram_facebook;
